...
Controle autônomo de profundidade, mapeamento,           |      Perda de sinal, falha nos sensores e
comunicação e resistência.                               |      consumo de bateria.
                                                         | 
                                                         |
---------------------------------------------------------------------------------------------------------------
4. Planejar o Próximo Ciclo:                             |      3. Desenvolver e Testar:
Testar em ambiente real, refinar algoritmos,             |      Construir um protótipo funcional.
e revisar requisitos de hardware.                        |
                                                         |
                                                         |
